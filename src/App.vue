<template>
  ...
  <get-data-row v-for="item in data_get" :key="item.id" :data="item" @update:data="handleUpdateData"
                @deleteRow="handleDeleteRow"></get-data-row>
  <div class="row my-3">
    <div class="col">
  ...
  <!-- 导出内容框 -->
  <export-content v-if="displayExport" :exportStr="exportStr"
                  @exportContentOff="displayExport = false"></export-content>
</template>
